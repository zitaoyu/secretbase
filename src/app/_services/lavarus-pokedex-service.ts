...
import {
  pokemonSimpleDataDatabaseLazarus,
  evolutionChainDatabase,
  abilityOverrideDatabase,
  fakemonDatabase,
} from "./databases/lazarus/index";
import myPokedex from "./pokeapi";

class LazarusPokedexPokedexService implements IPokedexService {
  private pokemonSimpleDataDatabase: PokemonSimpleData[];

  constructor() {
    this.pokemonSimpleDataDatabase = pokemonSimpleDataDatabaseLazarus;
  }
...
const LazarusPokedex = new LazarusPokedexPokedexService();

export default LazarusPokedex;
